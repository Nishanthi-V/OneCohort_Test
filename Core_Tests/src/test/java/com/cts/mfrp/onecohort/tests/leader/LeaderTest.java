...
public class LeaderTest extends BaseClassTest {
    ...
    public void testLeaderDashboardLoads() {
        ...
        softAssert.assertTrue(url.contains(AppConstants.URL_LEADER),
                "URL should contain " + AppConstants.URL_LEADER + ". Got: " + url);

        String leaderBadgeText = dashPage.getLeaderBadgeText();
        softAssert.assertTrue(leaderBadgeText.toLowerCase().contains(
        ...
        softAssert.assertFalse(kpiTitles.isEmpty(),
    ...
    public void testLeaderSidebarNavigation() {
        ...
        softAssert.assertTrue(navLinks.size() >= AppConstants.MIN_LEADER_NAV_LINKS,
        ...
        softAssert.assertTrue(hasCohortLink,
